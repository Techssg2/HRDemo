        ...
        function ($scope) {
          ...
          if ($scope.flow?.length) {
            ...
            $scope.showStep.rounds = rounds;
              ...
              if (!Array.isArray($scope.showStep.rounds) || $scope.showStep.rounds.length === 0) {
                  $scope.showStep.rounds = [{ 'stepNumber': $scope.step.stepNumber }];
              }

              console.log("ShowStep:" + JSON.stringify($scope.showStep));
          }
        },
      ],
    };
