    ...
    .factory('ssgexService', function($resource, $window, appSetting, $rootScope, interceptorService) {
        ...
        function createfactoryService() {
            ...
            return {
                ...
                createdPayload: $resource(url, null, {
                    retry: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "SSGEx", action: 'CreatedPayload' },
                        headers: customHeaders
                    },
                }),
                ...
                remoteDatas: $resource(url, null, {
                    ...
                    getOvertimeBalanceSet: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "SSGEx", action: 'GetOvertimeBalanceSet' },
                        headers: customHeaders
                    },
                    getMultiOvertimeBalanceSet: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "SSGEx", action: 'GetMultiOvertimeBalanceSet' },
                        headers: customHeaders
                    },
                    getOTHourInMonth: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "SSGEx", action: 'GetOTHourInMonth' },
                        headers: customHeaders
                    },
                    getShiftSetByDate: {
                        method: 'GET',
                    ...
                    updateUserInformationQuoteFromSAP: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "SSGEx", action: 'UpdateUserInformationQuoteFromSAP' },
                        headers: customHeaders
                    }
                }),
