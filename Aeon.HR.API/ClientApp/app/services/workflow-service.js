        ...
        function createfactoryService() {
            ...
            return {
                workflows: $resource(url, null, {
                    ...
                    reFindAssignToCurrentStep: {
                        method: 'GET',
                        url: url,
                        cache: true,
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "Workflow", action: 'ReFindAssignToCurrentStep' },
                        headers: customHeaders
                    },
                    checkReFindAssign: {
                        method: 'GET',
                        ...
                        cache: true,
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "Workflow", action: 'CheckReFindAssign' },
                        headers: customHeaders
                    },
                }),
                common: $resource(url, null, {
                    ...
                    getItemById: {
                        ...
                        url: url,
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "common", action: 'GetItemById' },
                        headers: customHeaders
                    }
                })
            }
