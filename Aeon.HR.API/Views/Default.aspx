...
<asp:Content ID="JsHolder" ContentPlaceHolderID="PlaceCustomJsHolder" runat="server">
    ...
    <script src="ClientApp/app/components/setting/business-model/business-model-controller.js?v=<%= Version  %>42"></script>
    <script src="ClientApp/app/components/setting/business-model-unit-mapping/business-model-unit-mapping-controller.js?v=<%= Version  %>42"></script>
