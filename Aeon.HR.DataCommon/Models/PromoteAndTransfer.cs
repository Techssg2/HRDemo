...
{
    public class PromoteAndTransfer : WorkflowEntity, IRecruimentEntity
    {
        public PromoteAndTransfer()
        {
        }
        ...
        public virtual MasterData ActingPosition { get; set; }
        public virtual JobGrade CurrentJobGradeGrade { get; set; } //===== CR11.2 =====
        public virtual JobGrade NewJobGrade { get; set; } //===== CR11.2 =====
    }
}