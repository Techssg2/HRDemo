          ...
          columns: [
            { field: "name", title: "Category List" },
            {
              ...
              command: [
                {
                  name: "edit",
                  text: $translate.instant("COMMON_EDIT"),
                  className: "btn btn-sm default blue-stripe no-icon",
                },
                {
                  name: "createchild",
                  text: $translate.instant("COMMON_SUBCATEGORY"),
                  className:
                    "add-child btn btn-sm default green-stripe no-icon",
                },
                {
                  name: "delete",
                  text: $translate.instant("COMMON_DELETE"),
                  className: "btn btn-sm default red-stripe no-icon",
