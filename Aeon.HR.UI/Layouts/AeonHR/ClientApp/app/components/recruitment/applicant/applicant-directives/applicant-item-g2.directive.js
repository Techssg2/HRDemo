var ssgApp = angular.module('ssg.directiveApplicantItemG2', []);
ssgApp.directive("applicantItemG2", [
    function ($rootScope) {
        return {
            restrict: "E",
            templateUrl: "ClientApp/app/components/recruitment/applicant/applicant-directives/applicant-item-g2.html",
            scope: {
                model: "=",
                form: "=",
                removeSubItem: "=bind",
            ...
            controller: [
                "$rootScope", "$scope", "settingService", "localStorageService", "masterDataService", "recruitmentService", "appSetting", "$timeout", "Notification", "settingService",
                function ($rootScope, $scope, settingService, localStorageService, masterDataService, recruitmentService, appSetting, $timeout, Notification, settingService) {
                    ...
                    this.$onInit = async () => {
                        ...
                        $timeout(function () {
                            $scope.optionGroup = {
                                ...
                                relationChange: function (e, list, index, emergencyContactPersonRelationship = '') {
                                    if (emergencyContactPersonRelationship) {
                                        $scope.model.emergencyContactPersonRelationshipName = e.sender.text();
                                    } else {
                                        list[index].relationShipName = e.sender.text();
                                    }
                                },
                                ...
                                schoolChange: function (e, list, index) {
                                    list[index].schoolName = e.sender.text();
                                },
                                myPositionOptions: {
                                    placeholder: "",
                                    dataTextField: "positionName",
                                    ...
                                    filtering: async function (option) {
                                        ...
                                        if (res.isSuccess) {
                                            var positionList = $("#positionId").data("kendoDropDownList");
                                            if (positionList) {
                                ...
                                levelOptions: {
                                    ...
                                    filter: "contains",
                                    filtering: $rootScope.dropdownFilter,
                                    dataSource: [{ code: 'Basic', name: 'Basic' }, { code: 'Intermediate', name: 'Intermediate' }, { code: 'Advanced', name: 'Advanced' }]
                                },
