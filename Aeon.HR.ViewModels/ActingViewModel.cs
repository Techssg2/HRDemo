...
namespace Aeon.HR.ViewModels
{
    public class ActingViewModel
    {
        ...
        public string FirstAppraiserSAPCode { get; set; }
        public string FirstAppraiserFullName { get; set; }
        public Guid? SecondAppraiserId { get; set; }
        public string SecondAppraiserSAPCode { get; set; }
        public string SecondAppraiserFullName { get; set; }
        public string EmployeeCode { get { return UserSAPCode; } }
