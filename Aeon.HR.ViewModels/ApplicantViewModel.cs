...
{
    public class ApplicantViewModel : AuditableEntity
    {
        public ApplicantViewModel()
        {
            ApplicantRelativeInAeons = new HashSet<ApplicantRelativeInAeonViewModel>();
            ApplicantEducations = new HashSet<ApplicantEducationViewModel>();
            ApplicantWorkingProcesses = new HashSet<ApplicantWorkingProcessViewModel>();
            PositionApplicantMappings = new HashSet<PositionApplicantMappingViewModel>();
            List_FamilyMemberSet = new HashSet<FamilyMemberViewModel>();
            List_EducationSet = new HashSet<EducationViewModel>();
            List_EmergencyContactSet = new HashSet<EmergencyContactViewModel>();
            List_AddressSet = new HashSet<AddressInfomationViewModel>();
            CharacterReferences = new HashSet<CharacterRefereeViewModel>();
            EmploymentHistories = new HashSet<EmploymentHistoryViewModel>();
            EmergencyContacts = new HashSet<EmergencyContactViewModel>();
            FamilyMembers = new HashSet<FamilyMemberViewModel>();
            InterviewEvaluates = new HashSet<InterviewEvaluateViewModel>();
            LanguageProficiencyEntries = new HashSet<LanguageProficiencyEntryViewModel>();
        ...
        public virtual ApplicantStatusRecruitmentViewModel ApplicantStatus { get; set; }
        public ICollection<FamilyMemberViewModel> List_FamilyMemberSet { get; set; }
        public ICollection<EducationViewModel> List_EducationSet { get; set; }
        public ICollection<AddressInfomationViewModel> List_AddressSet { get; set; }
        public ICollection<EmergencyContactViewModel> List_EmergencyContactSet { get; set; }
        public ICollection<ApplicantRelativeInAeonViewModel> ApplicantRelativeInAeons { get; set; }
        public ICollection<ApplicantEducationViewModel> ApplicantEducations { get; set; }
        public ICollection<ApplicantWorkingProcessViewModel> ApplicantWorkingProcesses { get; set; }
        public ICollection<PositionApplicantMappingViewModel> PositionApplicantMappings { get; set; }
        public ICollection<CharacterRefereeViewModel> CharacterReferences { get; set; }
        public ICollection<EmploymentHistoryViewModel> EmploymentHistories { get; set; }
        ...
        public ICollection<InterviewEvaluateViewModel> InterviewEvaluates { get; set; }
        public ICollection<LanguageProficiencyEntryViewModel> LanguageProficiencyEntries { get; set; }
        public ICollection<ActivityViewModel> Activities { get; set; }

    }
    public class PrositionApplicantViewModel
    {
        public Guid Id { get; set; }
        public string ReferenceNumber { get; set; }
        public string FullName { get; set; }
    ...
    public class SimpleApplicantViewModel
    {
        public Guid Id { get; set; }
        public Guid PositionId { get; set; }
        public string ReferenceNumber { get; set; }
    ...
    public class ExportPrositionDetailViewModel
    {
        public string ReferenceNumber { get; set; }
        public string FullName { get; set; }
        public string Email { get; set; }
