        ...
        function createfactoryService() {
            ...
            return {
                users: $resource(url, null, {
                    ...
                    getNewWorkLocationListV2: {
                        method: 'GET',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "Employee", action: 'GetNewWorkLocationListV2' },
                        headers: customHeaders
                    },
                    getCurrentUser: {
                        method: 'Get',
                    ...
                    getCurrentUserV2: {
                        method: 'Get',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "User", action: 'GetCurrentUserV2' },
                        headers: customHeaders
                    },
                    updateImageUser: {
                        method: 'POST',
                    ...
                    checkLockUser: {
                        ...
                        method: 'GET',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "User", action: 'GetAllUsers' },
                        headers: customHeaders
                    },
                    getAllUsersByKeyword: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "User", action: 'GetAllUsersByKeyword' },
                        headers: customHeaders
                    }
                }),
                ...
                departments: $resource(url, null, {
                    ...
                    getDepartmentByFilterV2: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "Department", action: 'GetDepartmentByFilterV2' },
                        headers: customHeaders
                    },
                    ...
                    getAllListDepartments: {
                        method: 'GET',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "Department", action: 'getAllListDepartments' },
                        headers: customHeaders
                    },
                    getDepartmentsByUserKeyword: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "Department", action: 'GetDepartmentsByUserKeyword' },
                        headers: customHeaders
                    }
                }),
                ...
                workflows: $resource(url, null, {
                    ...
                    changeStatusWorkflow: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "Workflow", action: 'ChangeStatusWorkflow' },
                        headers: customHeaders
                    }
                }),
                ...
                trackingRequest: $resource(url, null, {
                    ...
                    updatePayloadById: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "TrackingRequestSetting", action: 'UpdatePayloadById' },
                        headers: customHeaders
                    }
                }),
                ...
                btaPolicy: $resource(url, null, {
                    ...
                    deleteBTAPolicy: {
                        method: "POST",
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "BTAPolicy", action: 'DeleteBTAPolicy' },
                        headers: customHeaders
                    },
                    getBTAPolicyByJobGradePartition: {
                        method: "POST",
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "BTAPolicy", action: 'GetBTAPolicyByJobGradePartition' },
                        headers: customHeaders
                    },
                ...
                partition: $resource(url, null, {
                    createPartition: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "PartitionSetting", action: 'CreatePartition' },
                        headers: customHeaders
                    },
                    getListPartitions: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "PartitionSetting", action: 'GetListPartitions' },
                        headers: customHeaders
                    },
                    updatePartition: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "PartitionSetting", action: 'UpdatePartition' },
                        headers: customHeaders
                    },
                    deletePartition: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "PartitionSetting", action: 'DeletePartition' },
                        headers: customHeaders
                    },
                    getPartitionByCode: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "PartitionSetting", action: 'GetPartitionByCode' },
                        headers: customHeaders
                    }
                }),
                globalLocation: $resource(url, null, {
                    createGlobalLocation: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "GlobalLocationSetting", action: 'CreateGlobalLocation' },
                        headers: customHeaders
                    },
                    getListGlobalLocations: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "GlobalLocationSetting", action: 'GetListGlobalLocations' },
                        headers: customHeaders
                    },
                    updateGlobalLocation: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "GlobalLocationSetting", action: 'UpdateGlobalLocation' },
                        headers: customHeaders
                    },
                    deleteGlobalLocation: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "GlobalLocationSetting", action: 'DeleteGlobalLocation' },
                        headers: customHeaders
                    },
                    getGlobalLocationByCode: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "GlobalLocationSetting", action: 'GetGlobalLocationByCode' },
                        headers: customHeaders
                    },
                    getGlobalLocationByArrivalPartition: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "GlobalLocationSetting", action: "GetGlobalLocationByArrivalPartition" },
                        headers: customHeaders
                    }
                ...
                logHistory: $resource(url, null, {
                    getLogHistory: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "LogHistory", action: 'GetLogHistory' },
                        headers: customHeaders
                    },
                    saveLogHistory: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "LogHistory", action: "SaveLogHistory" },
                        headers: customHeaders
                    }
                }),
                businessModel: $resource(url, null, {
                    getBusinessModelList: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "BusinessModel", action: 'GetBusinessModelList' },
                        headers: customHeaders
                    },
                    updateBusinessModel: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "BusinessModel", action: 'UpdateBusinessModel' },
                        headers: customHeaders
                    },
                    deleteBusinessModel: {
                        method: 'GET',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "BusinessModel", action: 'DeleteBusinessModel' },
                        headers: customHeaders
                    },
                    createBusinessModel: {
                        method: 'POST',
                        interceptor: interceptorService.getInstance().interceptor,
                        params: { controller: "BusinessModel", action: 'CreateBusinessModel' },
                        headers: customHeaders
                    },
                }),
            }
