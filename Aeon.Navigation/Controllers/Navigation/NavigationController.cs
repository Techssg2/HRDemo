...
namespace Aeon.Navigation.Controllers.Navigation
{
    public class NavigationController : BaseController
    {
        ...
        [HttpGet]
        public async Task<IHttpActionResult> GetListNavigationByUserIsNotEdocHR()
        {
            try
            {
                var res = await _navigationBO.GetListNavigationByUserIsNotEdocHR();
                return Ok(new ResultDTO { Object = res });
            }
            catch (Exception ex)
            {
