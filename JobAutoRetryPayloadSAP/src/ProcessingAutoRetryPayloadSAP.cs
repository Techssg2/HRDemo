...
namespace JobAutoRetryPayloadSAP.src
{
    public class ProcessingAutoRetryPayloadSAP
    {
        ...
        public static async Task ProcessingAPI()
        {
            ...
            Utilities.WriteLogError("---------------- Start ProcessingAutoRetryPayloadSAP.ProcessingAPI -------------------");
