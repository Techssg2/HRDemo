...
namespace JobEmailDailyApproverEdoc1Edoc2.src
{
    public class ProcessingDailyEmailApprover
    {
        ...
        public static async Task ProcessingAPI()
        {
            ...
            Utilities.WriteLogError("---------------- Start JobEmailDailyApproverEdoc1Edoc2.ProcessingAPI -------------------");
