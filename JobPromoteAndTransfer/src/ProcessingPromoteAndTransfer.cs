...
namespace JobPromoteAndTransfer.src
{
    public class ProcessingPromoteAndTransfer
    {
        ...
        public static async Task ProcessingAPI()
        {
            ...
            Utilities.WriteLogError("---------------- Start JobPromoteAndTransfer.ProcessingAPI -------------------");
            ...
            try
            {
                ...
                Utilities.WriteLogError("ProcessingAPI.responseContent: " + responseContent);
