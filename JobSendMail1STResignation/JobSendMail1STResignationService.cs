using JobSendMail1STResignation.src;
using System;
...
{
    public partial class JobSendMail1STResignationService : ServiceBase
    {
        ...
        public JobSendMail1STResignationService()
        {
            InitializeComponent();
            Utilities.WriteLogError("JobSendMail1STResignationService(): start");
        }
